 ...
 */
public class RecapVmAllocationPolicy extends VmAllocationPolicyAbstract {
     ...
     * @post $none
     */
    public RecapVmAllocationPolicy() {
        super();
    ...
    public boolean allocateHostForVm(Vm vm) {
        ...
        //if VM has already assigned host
        ...
        //Allocate VM to the host that was assigned originally
        if (allocateHostForVm(vm, vm.getHost())) {
            return true;
        } else {
        	
        	Log.printFormattedLine("Unable to assign VM "+vm.getId()+ " to pre defined host "+ vm.getHost().getId());
        	return false;
